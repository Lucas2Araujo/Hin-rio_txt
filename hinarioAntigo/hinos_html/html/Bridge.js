...
// Text Align
function fontAlign(aln) {
    if (aln == 0) {
        document.getElementsByTagName("html")[0].setAttribute("align", "left");
    } else if (aln == 1) {
        document.getElementsByTagName("html")[0].setAttribute("align", "center");
    } else {
        document.getElementsByTagName("html")[0].setAttribute("align", "right");
    }
}
